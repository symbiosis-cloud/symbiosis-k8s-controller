...
func prepareCmdlineConfig() *Config {
	...
	var (
		...
		clusterID   = fs.String("cluster-id", "", "symbiosis cluster-id")
		apiKey      = fs.String("token", "", "symbiosis api key")
		basePath    = fs.String("symbiosis-api-endpoint", "https://api.symbiosis.host/", "symbiosis backend endpoint")
